...
public class MRecipeHistory {
    ...
    */
    ...
    @ColumnInfo(name = "RecipeHistoryId")
    private long RecipeHistoryId;
    ...
    public long getRecipeHistoryId() {
        return RecipeHistoryId;
    }

    public void setRecipeHistoryId(long recipeHistoryId) {
        RecipeHistoryId = recipeHistoryId;
    }
