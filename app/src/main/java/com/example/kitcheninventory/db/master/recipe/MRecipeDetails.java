...
public class MRecipeDetails {
    ...
    @ColumnInfo(name = "RecipeDetailsId")
    private long RecipeDetailsId;
    ...
    public long getRecipeDetailsId() {
        return RecipeDetailsId;
    }

    public void setRecipeDetailsId(long recipeDetailsId) {
        RecipeDetailsId = recipeDetailsId;
    }
