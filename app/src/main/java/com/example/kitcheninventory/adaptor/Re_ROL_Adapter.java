...
public class Re_ROL_Adapter extends RecyclerView.Adapter<Re_ROL_Adapter.RolViewHolder> {
    ...
    public Re_ROL_Adapter(RolReport rolReport, List<MItem> mItemList) {
        this.mContext = rolReport;
